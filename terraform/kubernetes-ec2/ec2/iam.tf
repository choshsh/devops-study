...
resource "aws_iam_instance_profile" "k8s_control_plane" {
  ...
  depends_on = [aws_iam_role.k8s_control_plane]
}

resource "aws_iam_instance_profile" "k8s_node" {
  name       = "k8s_node"
  role       = aws_iam_role.k8s_node.name
  depends_on = [aws_iam_role.k8s_node]
}
...
###########################################################
resource "aws_iam_policy_attachment" "k8s_control_plane" {
  name       = "k8s_control_plane"
  roles      = [aws_iam_role.k8s_control_plane.name]
...
resource "aws_iam_policy_attachment" "csi_driver" {
  name       = "csi_driver"
  roles      = [aws_iam_role.k8s_control_plane.name, aws_iam_role.k8s_node.name]
